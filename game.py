...
#Load audio file
mixer.music.load('music/jaz.mp3')
mixer.music.load('music/crash.wav')
mixer.music.load('music/jazzy.wav')

#Set preferred volume
mixer.music.set_volume(0.2)
#instead pygame.locals.FUNCTIONNAME
...
windowSurface = pygame.display.set_mode((700, 650))
...
# "Start" screen
drawText('Press any key to start the game.', font, windowSurface,
         (WINDOWWIDTH / 3) - 30, (WINDOWHEIGHT / 3))
drawText('And Enjoy', font, windowSurface, (WINDOWWIDTH / 3),
         (WINDOWHEIGHT / 3) + 30)
pygame.display.update()
waitForPlayerToPressKey()
zero = 0
if not os.path.exists("data-save.dat"):
  f = open("dat-/save.dat", 'w')
  f.write(str(zero))
  f.close()
...
while (count > 0):
  ...
  if (count == 0):
    ...
    drawText('Press any key to play again.', font, windowSurface,
             (WINDOWWIDTH / 3) - 80, (WINDOWHEIGHT / 3) + 30)
    pygame.display.update()
    time.sleep(2)
    waitForPlayerToPressKey()
    count = 3
